...
public class Mod_DB {
    ...
    public boolean conectarBD() {
        ...
        if (mod_general.Mod_General.gestorBD == 1) {// se conecta con mysql
            servidor = "localhost";
            basedatos = "base20251";
            usuario = "root";
            clave = "";
            mod_general.Mod_General.str_nombreBD = "Maria DB";
            //cadena de conección
            ...
            servidor = "DESKTOP-SM4GKPS\\SQLEXPRESS";
            basedatos = "dbFactura";
            usuario = "usr_ingles";
            clave   = "usr_ingles";
    
            mod_general.Mod_General.str_nombreBD = "SQL Server";
